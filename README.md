...
**nf-core/postcuration** is a bioinformatics pipeline that ...
...
```bash
nextflow run nf-core/postcuration \
...
<!-- If you use nf-core/postcuration for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
